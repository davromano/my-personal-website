...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' , width: '800px'}}>
  <img src='/spotify_business_graph.png' alt='Personas Gender Genre' style={{ width: '100%' , boxShadow: '0px 0px 15px 5px rgba(0,0,0,0.1)'}} />

  <img src='/spotify_business_words.png' alt='Personas Male Female' style={{ width: '100%' , boxShadow: '0px 0px 15px 5px rgba(0,0,0,0.1)'}} />
</div>
<div className="mt-4"/>
<img src={'/spotify-big-network.png'} alt="Ciao"  style={{ width: '800px' , boxShadow: '0px 0px 15px 5px rgba(0,0,0,0.1)'}}/>
<p className="text-dark-minsk justify-center pt-3 pb-5 text-sm"  style={{ fontFamily: 'tt-norms' }}>Religion podcasts network showing betweeneess centrality of nodes, clusters are colors</p>
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' , width: '800px'}}>
  ...
  <img src={'/spotify_business_graph.png'} alt="Ciao"  style={{ width: '100%' , boxShadow: '0px 0px 15px 5px rgba(0,0,0,0.1)'}} className="mb-4"/>
  <img src={'/spotify_business_words.png'} alt="Ciao"  style={{ width: '100%' , boxShadow: '0px 0px 15px 5px rgba(0,0,0,0.1)'}} className="mb-4"/>
</div>

...
date: "2023-01-01"
thumb: "../src/images/thumbs/voice.png"

---

import Summary from '../src/components/Summary';

<div style={{ fontFamily: 'tt-norms', display: 'flex', paddingTop:'10px'}} className="text-dark-minsk w-full md:w-3/5">
  <div className="w-1/3">
...
<div style={{ fontFamily: 'tt-norms', display: 'flex'}} className="text-dark-minsk w-full md:w-3/5">
  <div className="w-1/3">

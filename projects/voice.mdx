...
For our research phase, we got from the professor a project goal based on designing a citizen-driven platform similar to the one used in Zurich for <u className="text-dark-minsk"  style={{ fontFamily: 'tt-norms' }}><a href="https://www.zueriwieneu.ch/reports">collecting reports about city issues</a></u>.
...
<div className="w-3/5 items-center text-center text-lg">
...
the original goals by using it (e.g. if “Voice” increases citizens’ interest to be enrolled in community
governance).

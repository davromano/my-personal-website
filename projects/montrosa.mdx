...
date: "2023-07-01"
thumb: "../src/images/thumbs/montreux-thumb.jpg"
...
<img src='/keyword-selection.png' alt='Main' style={{ width: '100%'}} className="w-full sm:block md:hidden"/>

<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' , width: '700px', paddingBottom: '10px'}}>
  <img src='/keyword-selection.png' alt='Main' style={{ width: '100%'}} className="w-full md:block hidden"/>
  <img src='/generated-results-ipad.png' alt='Side' style={{ width: '100%'}} className="w-full md:block hidden"/>
</div>

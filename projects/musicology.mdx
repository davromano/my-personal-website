...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' , width: '700px', paddingBottom: '10px', paddingTop:'20px'}}>
  <img src='/music-ioi.png' alt='Main' style={{ width: '100%'}} />
  <img src='/music-similarity.png' alt='Side' style={{ width: '100%'}} />
</div>
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' , width: '700px', paddingBottom: '10px'}}>
  <img src='/music-results1.png' alt='Main' style={{ width: '100%'}} />
  <img src='/music-distribution-note.png' alt='Side' style={{ width: '100%'}} />
</div>
